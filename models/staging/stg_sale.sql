...
select
    ...
    case when coalesce(si.ischillerstock, 0) = 0 then il.quantity else 0 end as total_dry_items,
    case when coalesce(si.ischillerstock, 0) != 0 then il.quantity else 0 end as total_chiller_items,
