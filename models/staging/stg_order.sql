...
select
    ...
    safe.parse_date('%Y-%m-%d', substr(cast(o.orderdate as string), 1, 10)) as order_date_key,
    safe.parse_date('%Y-%m-%d', substr(cast(ol.pickingcompletedwhen as string), 1, 10)) as picked_date_key,
